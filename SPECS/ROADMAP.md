...
- [x] Use OpenCode as an interviewer to explore your interests and frustrations
- [x] Evaluate your best ideas against the 5-Point Filter (User, Problem, Value, Feasibility, Clarity)
- [x] Write your Founder Decision into `build-lab/MISSION.md`
...
- [x] Pass the 20-Second Simplicity Check
- [x] Define your Target User, Core Solution, and Primary CTA
- [x] Update `build-lab/MISSION.md` with the refined scope
...
- [x] Choose 3 personality words that define your brand
- [x] Define your color palette (Background, Primary, Accent, Text)
- [x] Choose typography (heading font + body font) and UI rules (border radius, spacing)
- [x] Save the full design system into `build-lab/MISSION.md`
...
- [x] Draft the 8-section page architecture (Navbar → Hero → Problem → Solution → Features → Social Proof → CTA → Footer)
- [x] Answer the core page questions for each section
- [x] Save the page outline into `build-lab/MISSION.md`
